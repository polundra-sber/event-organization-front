...
export const myPurchasesApi = api.injectEndpoints({
  endpoints: (builder) => ({
    ...
    editPurchaseCost: builder.mutation<void, { 
    event_id: number; 
    purchase_id: number; 
    ...
    denyPurchase: builder.mutation<void, { event_id: number; purchase_id: number }>({
    ...
    addReceipt: builder.mutation<void, { event_id: number; purchase_id: number; files: File[] }>({
    ...
    getReceipts: builder.query<ReceiptList, { event_id: number; purchase_id: number }>({
      query: ({ event_id, purchase_id }) => ({
